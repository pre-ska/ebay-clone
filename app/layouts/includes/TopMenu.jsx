        ...
        <div className="flex items-center justify-between w-full mx-auto max-w-[1200px]">
          ...
          >
            <li className="relative px-3">
              ...
              >
                <div>Login</div> <BsChevronDown />
              </Link>

              <div
                id="AuthDropdown"
                className={` hidden absolute bg-white w-[200px] text-[#333333] z-40 top-[20px] 
                left-0 border shadow-lg ${true ? "visible" : "hidden"} `}
              >
                <div>
                  <div className="flex items-center justify-start gap-1 p-3">
                    <img width={50} src="https://picsum.photos/200" />
                    <div className="font-bold text-[13px]">Pre Ska</div>
                  </div>
                </div>
